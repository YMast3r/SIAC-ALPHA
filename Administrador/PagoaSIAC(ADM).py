...
paso7= driver.find_element(By.XPATH, '/html/body/div/div/div[1]/div/table/tbody/tr[1]/td[8]/a')
paso7.click()

time.sleep(5)

paso8= driver.find_element(By.XPATH, '/html/body/div/div/div/table/tbody/tr/td[4]/a')
paso8.click()
...
paso10 = driver.find_element(By.ID, 'mes')
...
paso11 = driver.find_element(By.ID, 'anio')
select = Select(paso11)
...
paso13= driver.find_element(By.XPATH, '/html/body/div[2]/form/button')
paso13.click()
